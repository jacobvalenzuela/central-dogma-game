(function (glob) {
    ...
    cdapi.getTotalLeaderboard = async (sessionID, orderBy, numRows) => {
        if (NO_BACKEND) {
            ...
            return new Promise(function (resolve, reject) {
                let result = {
                    result: [{ levels: 1, score: 1386, userName: "wise-blue-bird", value: 1386 },
                    { levels: 4, score: 1287, userName: "strong-violet-shark", value: 1287 },
                    { levels: 6, score: 1188, userName: "strong-yellow-shark", value: 1188 },
                    { levels: 2, score: 1089, userName: "clever-orange-monkey", value: 1089 },
                    { levels: 2, score: 1005, userName: "heroic~yellow~snake~ca~12~non_binary~csv_test2", value: 1005 },
                    { levels: 2, score: 891, userName: "heroic~yellow~snake~ca~12~non_binary~csv_test2", value: 891 },
                    { levels: 1, score: 891, userName: "heroic-pink-pig", value: 891 },
                    { levels: 3, score: 871, userName: "funny-yellow-shark", value: 871 },
                    { levels: 3, score: 594, userName: "funny-yellow-shark", value: 594 },
                    { levels: 4, score: 469, userName: "strong-violet-shark", value: 469 },
                    { levels: 6, score: 469, userName: "strong-yellow-shark", value: 469 },
                    { levels: 3, score: 396, userName: "funny-yellow-shark", value: 396 },
                    { levels: 6, score: 335, userName: "strong-yellow-shark", value: 335 },
                    { levels: 4, score: 0, userName: "strong-violet-shark", value: 0 },
                    { levels: 2, score: 0, userName: "clever-orange-monkey", value: 0 },
                    { levels: 1, score: 0, userName: "strong-pink-bear", value: 0 },
                    { levels: 6, score: 0, userName: "strong-yellow-shark", value: 0 },
                    { levels: 6, score: 0, userName: "strong-yellow-shark", value: 0 },
                    { levels: 6, score: 0, userName: "strong-yellow-shark", value: 0 }],
                    status: "ok"
                }
