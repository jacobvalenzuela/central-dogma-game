    ...
    init(data) {
        ...
        if (this.levelConfig.lvlType == "dna_replication") {
            ...
            */
            ...
            // Label entire APE site as a ribosome
            this.game.add.text(30, 560, "Ribosome",
            {fontFamily: 'Teko', fontSize: '32pt', color: '#000000'}).setDepth(1).setAlpha(1).setAngle(270).setDepth(105);;
            this.graphicsOverlay.fillStyle(WHITE, 1.0);
            this.graphicsOverlay.fillRoundedRect(30, 420, 40, 150, 15);
